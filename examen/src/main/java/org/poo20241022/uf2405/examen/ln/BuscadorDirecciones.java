...
public interface BuscadorDirecciones {
	...
	Object listDireccionesByCodigoPais(String string) throws ServicioException;

    Direccion conseguirDireccionByDepartamentoId(Integer i) throws ServicioException;
